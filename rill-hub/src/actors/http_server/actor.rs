...
#[async_trait]
impl StartedBy<EmbeddedNode> for HttpServer {
...
#[async_trait]
impl InterruptedBy<EmbeddedNode> for HttpServer {
    async fn handle(&mut self, ctx: &mut Context<Self>) -> Result<(), Error> {
        ctx.shutdown();
        Ok(())
    }
...
#[async_trait]
impl InteractionHandler<Req<Index>> for HttpServer {
    async fn handle(
        &mut self,
        _: Req<Index>,
        _ctx: &mut Context<Self>,
    ) -> Result<Response<Body>, Error> {
        let response = Response::builder().body(Body::from("Rill Export Inner HttpServer"))?;
        Ok(response)
    }
}
...
#[async_trait]
impl InteractionHandler<Req<ForwardToUi>> for HttpServer {
    async fn handle(
        &mut self,
        _: Req<ForwardToUi>,
        _ctx: &mut Context<Self>,
...
#[async_trait]
impl InteractionHandler<Req<Info>> for HttpServer {
    async fn handle(
        &mut self,
        _: Req<Info>,
        _ctx: &mut Context<Self>,
...
#[async_trait]
impl ActionHandler<WsReq<ProviderLive>> for HttpServer {
    async fn handle(
        &mut self,
...
#[async_trait]
impl Eliminated<ProviderSession> for HttpServer {
    async fn handle(
        &mut self,
...
#[async_trait]
impl ActionHandler<WsReq<ClientLive>> for HttpServer {
    async fn handle(
        &mut self,
...
#[async_trait]
impl Eliminated<ClientSession> for HttpServer {
    async fn handle(
        &mut self,
...
#[async_trait]
impl InteractionHandler<Req<Ui>> for HttpServer {
    async fn handle(
        &mut self,
        msg: Req<Ui>,
        _ctx: &mut Context<Self>,
...
#[async_trait]
impl TaskEliminated<FetchUiPack> for HttpServer {
    async fn handle(
        &mut self,
...
#[async_trait]
impl Scheduled<InitAssets> for HttpServer {
    async fn handle(
        &mut self,
        _: Instant,
        _: InitAssets,
